...
#
#
# HPM_calculate_stagnation.py: here, the conditions right behind the NSW are computed (not at the nose directly!)
#
...
def GetStagPointConditions(Minf, pinf, rhoinf, Tinf, R):
